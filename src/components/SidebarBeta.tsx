import { ArrowRightLeft, Home, Monitor } from "lucide-react";
...
export default function SidebarBeta({ route, navigate }: SidebarProps) {
	const items = [
		{ route: "dashboard", label: "Dashboard", icon: Home },
		{ route: "assets", label: "Activos", icon: Monitor },
		{ route: "movimientos", label: "Movimientos", icon: ArrowRightLeft },
	];
